...
**Three reporting views, consistent organization totals, and quality checks that block invalid output.** This Python project turns market and organization data into Full, Addressable, and Weighted market scenarios. A runnable synthetic demo makes the transformations and controls easy to inspect.
...
The public demo uses synthetic inputs and needs no company account or private service. The production case study describes a wider Python and Qlik workflow whose private connectors are excluded. See the [scope and limitations](docs/PUBLIC_DEMO_BOUNDARY.md).
...
| Production case study | Selenium ingestion, Qlik Cloud reporting, BPMN 2.0 process documentation |
...
The original workflow combined commercial sources with inconsistent formats and product definitions. Spreadsheet preparation made reporting slow and dependent on specialist knowledge. Configuration-driven rules, reconciliation, and handover documentation made the process repeatable.
